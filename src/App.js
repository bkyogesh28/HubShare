...
// import logo from '/img/HubShare.png';
    ...
    return (
      <div className="App">
        <header className="App-header">
          <div className="Logo">
            {/* <img src="../public/img/HubShare.png" /> */}
            
          </div>
          <div className="Title"><h1>HubShare</h1></div>
          <div className="TagLine"><h3>Hub to share files securely using IPFS</h3></div>
        </header>
